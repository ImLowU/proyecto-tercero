 ...
 * de database/seed_sporttime.sql —roles, usuarios base, tipos_torneo, modulos— se dan por
 * existentes; lo demás se genera y se limpia en cada corrida.
 *
 * Ids de usuario que aporta seed_sporttime.sql y que acá se usan como dueños:
