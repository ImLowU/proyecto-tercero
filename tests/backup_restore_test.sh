...
generar_dump() { # <archivo> <tabla...> — sin la línea de cierre
    local archivo="$1"; shift
    {
        ...
        echo "--"
        echo "-- Host: localhost    Database: sporttime"
...
# De otra base: bien formado y completo, pero sin las tablas de SportTime.
...
afirmar_contiene "faltan tablas de SportTime" "$SALIDA" "dice que tablas faltan"
afirmar_igual "0" "$(archivos_en_backups)" "tampoco deja archivo"
...
afirmar_contiene "faltan tablas de SportTime" "$SALIDA" "y dice cuales faltan"
