...
/**
 * Test de `database/seed_sporttime.sql` por su cuenta.
 *
...
final class SeedBaseTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $sql = file_get_contents(dirname(__DIR__) . '/database/seed_sporttime.sql');
        if ($sql === false) $this->fallar('No se pudo leer database/seed_sporttime.sql.');
        $this->db->exec($sql);
