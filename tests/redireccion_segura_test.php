...
if (!defined('APP_URL')) define('APP_URL', 'https://sporttime.local');
...
final class RedireccionSeguraTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        $_SERVER['HTTP_HOST'] = 'sporttime.local';
    }
    ...
    public function test_una_url_absoluta_del_mismo_host_se_reduce_a_su_ruta(): void
    {
        ...
        $this->assertSame('/admin/torneos/5',
            Url::rutaInterna('https://sporttime.local/admin/torneos/5'));

        $this->assertSame('/admin/torneos?estado=en_curso',
            Url::rutaInterna('http://sporttime.local:8080/admin/torneos?estado=en_curso'));
    }
    ...
    private function destinosExternos(): array
    {
        return [
            ...
            'subdominio parecido'          => 'https://sporttime.local.sitio-falso.com/',
            'host que contiene al nuestro' => 'https://malo.com/?x=sporttime.local',
