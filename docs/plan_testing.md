# Plan de Testing Manual — SportTime

## Módulo: Autenticación

| # | Caso | Entrada | Resultado esperado |
|---|------|---------|-------------------|
| 1 | Login correcto admin | admin@sporttime.com / password | Redirige a /admin |
| 2 | Login correcto organizador | org1@sporttime.com / password | Redirige a /organizador |
...
| 5 | Contraseña incorrecta | admin@sporttime.com / mal | "Email o contraseña incorrectos" |
