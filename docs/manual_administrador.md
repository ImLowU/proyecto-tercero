# Manual de Administrador — SportTime
...
./scripts/backup.sh
# Genera: backups/sporttime_YYYYMMDD_HHMMSS.sql.gz
```

## Restaurar respaldo

```bash
./scripts/restore.sh backups/sporttime_20260601_120000.sql.gz
```
...
| `DB_PASS` | Contraseña del usuario sporttime_user |
