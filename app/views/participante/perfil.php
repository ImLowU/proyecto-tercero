...
<details class="form-card" id="editar" style="margin-top:1rem">
  <summary style="cursor:pointer;font-weight:700;color:var(--color-text);list-style:none">✏️ Editar mi información</summary>
  <form method="POST" action="/participante/perfil" enctype="multipart/form-data" style="margin-top:1rem">
    ...
    <div class="form-grid">
      <div class="field col-span-full">
        ...
        <span class="field-hint">JPG, PNG, WEBP o GIF. Máx 2 MB. Dejá vacío para conservar la actual.</span>
      </div>
      <div class="field">
...
<details class="form-card" style="margin-top:1rem;border-left:3px solid #c0392b">
  <summary style="cursor:pointer;font-weight:700;color:#ffb3b3;list-style:none">Eliminar mis datos personales</summary>
