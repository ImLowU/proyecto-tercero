...
<form method="POST" action="/admin/equipos/<?= $equipo ? 'editar/' . (int)$equipo['id'] : 'crear' ?>" class="form-card" enctype="multipart/form-data">
  ...
  <div class="form-grid">
    <div class="field col-span-full">
      ...
      <span class="field-hint">JPG, PNG, WEBP o GIF. Máx 2 MB.</span>
    </div>
    <div class="field">
      <label>Nombre *</label>
...
<div class="panel">
  ...
  <?php else: ?>
    ...
    <div class="between" style="padding:.5rem 0;border-bottom:1px solid var(--color-border)">
      <div class="cluster">
        <strong><?= View::e($p['nombre']) ?></strong>
        <span class="chip"><?= View::e($p['rol_en_equipo']) ?></span>
      </div>
