...
<form method="POST" action="/admin/torneos/<?= $torneo ? 'editar/' . (int)$torneo['id'] : 'crear' ?>" class="form-card" id="torneoForm">
  ...
  <div class="form-section">
    ...
    <div class="form-grid">
      ...
      <div class="field" id="campoMinEquipo">
        ...
        <span class="field-hint">Los equipos con menos integrantes no podrán inscribirse.</span>
      </div>
      ...
      <div class="field">
        ...
        <?php if (!Auth::isAdmin()): ?>
          <span class="field-hint">Solo un administrador puede reasignar el torneo a otro organizador.</span>
        <?php elseif (empty($organizadores)): ?>
          <span class="field-hint warn">No hay organizadores. Creá uno en “Organizadores” antes de crear un torneo.</span>
        <?php endif; ?>
      </div>
      ...
      <div class="field col-span-full">
        ...
        <textarea name="descripcion" placeholder="Información del torneo, sede, reglas particulares…"><?= View::e($torneo['descripcion'] ?? '') ?></textarea>
      </div>
  ...
  <!-- ── Sección: Puntuación y reglas del formato ───────── -->
  <div class="form-section">
    <h3 class="form-section-title">Puntuación y reglas del formato</h3>
    <div class="form-grid">
      <div class="field">
