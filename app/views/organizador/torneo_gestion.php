...
<div id="modalCargar" class="modal" style="display:none" aria-hidden="true">
...
<div id="modalCorregir" class="modal" style="display:none" aria-hidden="true">
  <div class="form-card modal-card" style="width:min(100%,500px)">
    ...
    <div class="alert warning mb-3">
      ...
      <span>Esta solicitud quedará <strong>pendiente de aprobación administrativa</strong>. El resultado no cambia hasta que un administrador la apruebe.</span>
    </div>
    <form method="POST" action="/organizador/correcciones/solicitar">
      ...
      <div class="form-grid">
        ...
        <div class="field col-span-full"><label>Motivo *</label><textarea name="motivo_correccion" required minlength="10" placeholder="Explicá por qué debería corregirse…"></textarea></div>
      </div>
      <div class="form-actions">
...
<div id="modalProgramar" class="modal" style="display:none" aria-hidden="true">
  <div class="form-card modal-card">
