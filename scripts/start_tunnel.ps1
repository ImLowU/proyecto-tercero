# ============================================================
# start_tunnel.ps1 — Inicia un Cloudflare Tunnel efímero para SportTime
# Fuerza Host: sporttime.local para que Apache sirva el proyecto (no htdocs).
...
Start-Process "cloudflared" `
    -ArgumentList 'tunnel','--url','http://localhost:80','--http-host-header','sporttime.local','--no-autoupdate' `
